...
const NAV_ITEMS = [
  ...
  { to: '/admin/campaigns', icon: MdCampaign, label: 'Campaigns' },
  { to: '/admin/withdrawals', icon: MdAccountBalanceWallet, label: 'Withdrawals' },
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 lg:ml-64">
        <div className="lg:hidden flex items-center justify-between bg-white border-b border-gray-100 px-4 py-3">
          ...
          <span className="font-black text-dark text-sm">Admin Panel</span>
